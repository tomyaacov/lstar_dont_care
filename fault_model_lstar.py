from aalpy.oracles import BreadthFirstExplorationEqOracle, RandomWalkEqOracle
...
oracle = RandomWalkEqOracle(tuple(B.get_input_alphabet()), sul, 10000)
#oracle = BFEOracle(B.get_input_alphabet(), sul, depth=7)
dfa3, data = run_Lstar(B.get_input_alphabet(), sul, oracle, cex_processing='rs', closing_strategy='single',
...
save_automaton_to_file(dfa_a, path="output/" + example + "_mealy_a")
