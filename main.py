...
def run_n_tests(example, bug, n, oracle_opt, test_set_size, name):
    c = Counter()
...
#             current_results = run_n_tests(example + "_m_" + current, bug, n, oracle_opt, test_sample_size, example + "_" + current )
